...
class Diff {
    ...
    getSourceHtml(templateVars) {
        const diffs = this.getSourceDiffs()
        return this.getHtml(diffs, templateVars)
    }

    getRenderedHtml(templateVars) {
        const diffs = this.getRenderedDiffs()
        return this.getHtml(diffs, templateVars)
    }

    writeSourceHtml(fileName, templateVars) {
        return this.writeHtml(this.getSourceHtml(templateVars), fileName)
    }

    writeRenderedHtml(fileName, templateVars) {
        return this.writeHtml(this.getRenderedHtml(templateVars), fileName)
    }
    ...
    writeSourcePdf(fileName, pdfOptions, launchOptions, templateVars) {
        return this.writePdf(this.getSourceHtml(templateVars), fileName, pdfOptions, launchOptions)
    }

    writeRenderedPdf(fileName, pdfOptions, launchOptions, templateVars) {
        return this.writePdf(this.getRenderedHtml(templateVars), fileName, pdfOptions, launchOptions)
    }
