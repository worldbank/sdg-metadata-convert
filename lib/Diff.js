...
class Diff {
    ...
    writeSourceHtml(fileName) {
        this.writeHtml(this.getSourceHtml(), fileName)
    }

    writeRenderedHtml(fileName) {
        this.writeHtml(this.getRenderedHtml(), fileName)
    }
    ...
    writeSourcePdf(fileName, pdfOptions, launchOptions) {
        this.writePdf(this.getSourceHtml(), fileName, pdfOptions, launchOptions)
    }

    writeRenderedPdf(fileName, pdfOptions, launchOptions) {
        this.writePdf(this.getRenderedHtml(), fileName, pdfOptions, launchOptions)
    }
    ...
    writePdf(html, fileName, pdfOptions, launchOptions) {
        ...
        convertHTMLToPDF(html, pdf => {
            ...
            else fs.writeFile(fileName, pdf, err => {
                if (err) throw err
                console.log('Saved ' + fileName)
            })
