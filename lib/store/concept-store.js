...
function getConcept(findId) {
    ...
    if (!concept) {
        throw new InputError(`WARNING: Concept with id "${findId}" cannot be found in concept-store.js.`)
    }
    else {
        return concept
    }
...
function getConceptIdByName(findName) {
    ...
    if (!concept) {
        throw new InputError(`WARNING: Concept with name "${findName}" cannot be found in concept-store.js.`)
    }
    else {
        return concept.id
    }
