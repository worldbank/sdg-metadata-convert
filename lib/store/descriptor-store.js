...
function getDescriptor(findId) {
    ...
    if (!descriptor) {
        throw new InputError(`WARNING: Descriptor with id "${findId}" cannot be found in descriptor-store.js.`)
    }
    else {
        return descriptor
    }
...
function getDescriptorIdByName(findName) {
    ...
    if (!descriptor) {
        throw new InputError(`WARNING: Descriptor with name "${findName}" cannot be found in descriptor-store.js.`)
    }
    else {
...
function getOptionKeyByValue(optionValue, descriptorId) {
    ...
    if (!option) {
        throw new InputError(`WARNING: Descriptor option with value "${optionValue}" cannot be found in descriptor-store.js.`)
        return ''
    }
    return option.key
}
