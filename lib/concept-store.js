function getConcepts() {
    return [
        ...
        {
            id: 'FREQ_COLL',
            name: '3.d. Data collection calendar',
            section: 'SRC_TYPE_COLL_METHOD',
        },
        {
            id: 'REL_CAL_POLICY',
            name: '3.e. Data release calendar',
            section: 'SRC_TYPE_COLL_METHOD',
        },
        {
            id: 'DATA_SOURCE',
            name: '3.f. Data providers',
            section: 'SRC_TYPE_COLL_METHOD',
        },
        {
            id: 'COMPILING_ORG',
            name: '3.g. Data compilers',
            section: 'SRC_TYPE_COLL_METHOD',
        },
        {
            id: 'INST_MANDATE',
            name: '3.h. Institutional Mandate',
            section: 'SRC_TYPE_COLL_METHOD',
        },
        {
            id: 'OTHER_METHOD',
        ...
        {
            id: 'QUALITY_MGMNT',
            name: '4.i. Quality assurance',
            section: 'OTHER_METHOD',
        },
        {
            id: 'QUALITY_ASSURE',
            name: '4.i.i. QA: Practices and guidelines',
            section: 'OTHER_METHOD',
        },
        {
            id: 'QUALITY_ASSMNT',
            name: '4.i.ii. QA: Assessment',
            section: 'OTHER_METHOD',
        },
        {
            id: 'SDG_QA_CONSULT',
            name: '4.i.iii. QA: Consultation process',
            section: 'OTHER_METHOD',
        },
        {
            id: 'COVERAGE',
